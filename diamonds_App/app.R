# Interactive Shiny Web-Apps, Diamonds
...
# You will again be working with the `diamonds` dataset provided by ggplot2
# Use dplyr's `sample_n()` function to get a random 1000 rows from the dataset
...
# For convenience, get a vector of column names from the `diamonds` dataset to
...
# the columns of the diamond dataset. Use the `carat` column as a default
